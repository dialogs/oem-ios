Pod::Spec.new do |s|
  ...
  s.platform                = :ios, "11.0"
  s.requires_arc            = true
  s.vendored_frameworks     = "Products/DialogNotificationService.framework", "Products/DialogNotificationService.framework/Frameworks/DialogNotificationServiceExtension.framework"
