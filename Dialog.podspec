Pod::Spec.new do |s|
  ...
  s.dependency 'gRPC', '1.23.0'
  s.dependency 'gRPC-Core', '1.23.0'
  s.dependency 'gRPC-ProtoRPC', '1.23.0'
  s.dependency 'gRPC-RxLibrary', '1.23.0'
  ...
  s.dependency 'PINOperation', '1.1.2'
  ...
  s.dependency 'RxASDataSources'#, :git => 'https://github.com/dialogs/RxASDataSources', :branch => 'bump-rx-5.1'
  ...
  s.dependency 'Texture'#, :git => 'https://github.com/dialogs/Texture.git', :tag => '2.8.1.3'
