Pod::Spec.new do |s|
  ...
  s.dependency 'DialogSDK-GRPC'#, :git => 'https://github.com/dialogs/api-schema.git', :tag => 'v1.82.0'
  ...
  s.dependency 'DLGPicker'#, :git => 'https://github.com/dialogs/Alerts-Pickers', :tag => '1.0.44'
  ...
  s.dependency 'InputBarAccessoryView'#, :git => 'https://github.com/nathantannar4/InputBarAccessoryView.git', :tag => '5.1.0'
  ...
  s.dependency 'SwiftLint', '0.37.0'
  s.dependency 'SwiftProtobuf', '1.7.0'
  s.dependency 'Swinject', '2.7.1'
  s.dependency 'Texture'#, :git => 'https://github.com/dialogs/Texture.git', :tag => '3.0.0.2'
