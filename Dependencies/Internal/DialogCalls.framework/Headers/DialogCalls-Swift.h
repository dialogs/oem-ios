...
#ifndef DIALOGCALLS_SWIFT_H
#define DIALOGCALLS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DialogCalls",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC11DialogCalls18CallPeerConnection")
@interface CallPeerConnection : NSObject
...
@interface CallPeerConnection (SWIFT_EXTENSION(DialogCalls)) <RTCPeerConnectionDelegate>
