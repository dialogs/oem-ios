 ...
 **/
GPB_FINAL @interface GAPIHTTPRoot : GPBRootObject
@end
 ...
 **/
GPB_FINAL @interface GAPIHttp : GPBMessage
 ...
 **/
GPB_FINAL @interface GAPIHttpRule : GPBMessage
 ...
 **/
GPB_FINAL @interface GAPICustomHttpPattern : GPBMessage
