...
#ifndef DIALOGSPEECH_SWIFT_H
#define DIALOGSPEECH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DialogSpeech",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12DialogSpeech21DialogSpeechUtterance")
@interface DialogSpeechUtterance : AVSpeechUtterance
@property (nonatomic, readonly) NSUInteger hash;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithString:(NSString * _Nonnull)string SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithAttributedString:(NSAttributedString * _Nonnull)string SWIFT_UNAVAILABLE;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC12DialogSpeech24SpeechSynthesizerService")
@interface SpeechSynthesizerService : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface SpeechSynthesizerService (SWIFT_EXTENSION(DialogSpeech)) <AVSpeechSynthesizerDelegate>
